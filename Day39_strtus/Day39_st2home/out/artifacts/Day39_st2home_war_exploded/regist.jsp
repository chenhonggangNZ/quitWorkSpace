...
<html>
  ...
  <body>
  <h1>注册</h1>
<p style="color: red; font-weight: 900">${requestScope.message}</p>
<form action="/register.action" method="post" id="submits"><%--http://localhost:8080/user;--%>
	<input type="hidden" value="register" name="method">
	<input type="hidden" name="method" value="regist"/>
	用户名：<input type="text" name="username" id="username" value=""/><br/>
	密　码：<input type="password" id="password" name="password"/><br/>
	呢　称：<input type="text" name="nickname" id="nickname" value=""/><br/>
