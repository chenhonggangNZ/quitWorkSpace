...
public class UserDao {
    ...
    public static void add(String username, String password, String nickname) throws SQLException {
        Connection connection = C3P0Util.getConnection();
        String sql = "INSERT INTO users VALUES(null,?,?,?,'未填写','未填写')";
        queryRunner.update(connection,sql,username,nickname,password);
        C3P0Util.release(null,null,connection);
    }

    public static void add(String username, String password, String nickname, String telphone, String email) throws SQLException {
        Connection connection = C3P0Util.getConnection();
        String sql = "INSERT INTO users VALUES(null,?,?,?,?,?)";
        queryRunner.update(connection,sql,username,nickname,password,telphone,email);
        C3P0Util.release(null,null,connection);
    }
}
